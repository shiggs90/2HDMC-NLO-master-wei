...
class Constraints {
  ...
  */
  ...
  //  by wei at 2019-july-16 // begain
    //
  bool get_BR_Hpm(double& br_tHb,double br_Hpquqd[3][3],double br_Hplv[3], double br_hpwhi[3]);
  
  bool get_BR_Hi(double br_hiuu[3][3], double br_hidd[3][3], double  br_hill[3][3], double br_hiww[3],double br_hizz[3], double br_higaga[3], double br_higg[3],double br_hihjhj[3][3],double br_hizhj[3][3],double br_hiwhpm[3],double br_hihpmhpm[3]);
  
  bool get_BR_HH(double br_hihjhj[4][4]);
  bool get_BR_HV(double br_hivhj[4][4]);
  bool get_Gamma(double gamma[4]);

  bool get_ggHXS(double& xsratioA, double& xsratioh, double&  xsratioH) ;
  bool get_ggHXS_NLO(double& xsratioA, double& xsratioh, double&  xsratioH) ;
  bool get_bbHXS(double& xsratioA, double& xsratioh, double&  xsratioH) ;
    
  bool get_lambdahhh(double& lambdahhhratio);
  bool get_ttHXS(double& xsratioA, double& xsratioh, double&  xsratioH) ;
  bool get_ZZHXS(double& xsratioA, double& xsratioh, double&  xsratioH) ;
  bool get_WWHXS(double& xsratioA, double& xsratioh, double&  xsratioH) ;
