...
int main(){
    ...
    string infile1name=fname1+"/Type"+name1.str()+"_H1_scan"+name2.str()+"_lhcinp.txt";
    ifstream infile1;
    ...
    string outfile1name=fname1+"/Type"+name1.str()+"_H1_scan"+name2.str()+"_ratio.txt";
    ...
    string outfile2name=fname1+"/Type"+name1.str()+"_H1_scan"+name2.str()+"_ratio_detail.txt";
